...
const PricingSection = () => {
  ...
  return (
    <section className="bg-[#8ECAE6] py-16 px-4">
        ...
        {plans.map((plan, idx) => (
          ...
          >
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className={`text-3xl font-extrabold ${plan.bg.includes("text-white") ? "text-white" : "text-[#023047]"}`}>
                ${plan.price} <span className="text-base font-normal">Monthly</span>
              </p>
            </div>
            <ul className={`space-y-2 mb-6 ${plan.bg.includes("text-white") ? "text-white" : "text-[#023047]"}`}>
